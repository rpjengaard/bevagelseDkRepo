  ...
  <div>
    ...
    <div class="relative max-w-4xl mx-auto pt-8 mt-4 mb-4 px-4 sm:px-6 lg:px-8">
      <div class="max-w-3xl mx-auto text-center">
        <h2 class="text-3xl font-extrabold text-bevagelse-blue-dark">Hvad kan Bevägelse hjælpe dig med?</h2>
        <!-- <p class="mt-4 text-lg text-black">Ac euismod vel sit maecenas id pellentesque eu sed consectetur. Malesuada adipiscing sagittis vel nulla nec.</p> -->
      </div>
      <dl class="mt-12 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 lg:grid-cols-3 lg:gap-x-8">
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium text-gray-900">Genoptræning</p>
          </dt>
          <!-- <dd class="mt-2 ml-9 text-base text-black">
            Magna a vel sagittis aliquam eu amet. Et lorem auctor quam nunc odio. Sed bibendum.
          </dd> -->
